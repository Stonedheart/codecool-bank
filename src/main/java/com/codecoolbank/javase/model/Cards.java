...
public class Cards extends AbstractBaseModel {
    ...
    public Cards(Integer id, String number, String validity, BigDecimal buyingLimit, BigDecimal cashWithDrawLimit, BigDecimal limit, CardTypes cardType, CardStatuses cardStatus, Accounts account) {
        super(id);
        this.number = number;
        this.validity = validity;
        this.buyingLimit = buyingLimit;

...
public class Transactions extends AbstractCodecoolBankModel {
    ...
    public Transactions(Integer id, String dateOfTransaction, BigDecimal value, String description, TransactionTypes transactionType, TransactionStatuses transactionStatus, Account account, Card card) {

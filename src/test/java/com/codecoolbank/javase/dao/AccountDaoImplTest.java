...
class AccountDaoImplTest {
    @Test
    void testInsertSavingAccountToDbInsertQuery() throws SQLException, InvalidValue {
    ...
    @Test
    void testInsertDebitAccountToDbInsertQuery() throws SQLException, InvalidValue {
        AccountDaoImpl accountDaoImpl = new AccountDaoImpl();
        Customer testCustomer = new Customer("Marian", "Nowak", "mrn", "1234", "01-01-2012", true, "10-11-2016");
        AccountType accountType = new AccountType(1, "Saving account", "Account for your savings, percentage 5%");
        AccountStatus accountStatus = new AccountStatus(1, "Active", "Account is active");

        DebitAccount debitAccount = new DebitAccount(1, testCustomer, "00008798123400000012", accountType, accountStatus, "12-02-2015", BigDecimal.valueOf(2500.00), BigDecimal.valueOf(0.00), 5);
